...
public class DoctorLogIn extends JFrame{
    ...
    public void intcomponent(){
     ...
     //   backButton.setBackground(new Color(0,0,0,150));
        ...
        JLabel loginSubTitle=new JLabel("Doctor Login Panel");
       ...
       JTextField userText =new JTextField();
        ...
        loginButton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                if(userText.getText().isEmpty() && passwordText.getText().isEmpty()){
                    ...
                    if(ls.doctorValidation(userText.getText(),passwordText.getText())){
        ...
        //background
        ImageIcon background_image=new ImageIcon("images/doctorlogin.jpg");
